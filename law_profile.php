	...
	<div class="w3-third">
		<div class="w3-white w3-text-black w3-card-4">
			<div class="w3-display-container">
				<img src="img/sapan-r-patel-advocate.jpg" style="width:486px; height:210px" alt="Avatar">
			...
			<div class="w3-container"><br>
				...
				<p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-black"></i><?php echo $id; ?></p>
	...
	<div class="w3-twothird">
		<div class="w3-container w3-card w3-white w3-margin-bottom">
			...
			<div class="w3-container">
				<h5 class="w3-opacity"><b><?php echo $desi; ?>/<?php echo $address_office; ?></b></h5>
...
<div id="id01" class="modal">
    ...
    <div class="container">
		<form class="modal-content" action="update_lawyer.php" method="post">
			<img src="img/sapan-r-patel-advocate.jpg" style="width:50px; height:50px;" alt="Avatar">
			<input type="file" name="image_law" id="files" class="hidden"><label for="files">upload profile</label><br><br>
			Name:
